...
<body>
        ...
        <main class="content">
            ...
            <form id="editStudentForm">
                ...
                <div class="form-actions">
                    ...
                    <button type="button" onclick="deleteStudent()" class="btn btn-danger">Delete</button>
                </div>
            </form>
        </main>
    </div>
    ...
    <script>
        // Get student ID from server-side variable
        window.studentId = ${studentId};
    </script>
    <script src="<c:url value='/js/edit-student.js'/>"></script>
</body>
</html>
